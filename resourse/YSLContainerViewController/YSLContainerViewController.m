     ...
     parentViewController:(UIViewController *)parentViewController
{
    ...
    if (self) {
        ...
        _menuBackGroudColor = [UIColor whiteColor];
        _menuItemFont = [UIFont systemFontOfSize:15];
        _menuItemSelectedTitleColor = GREEN_COLOR;
        _menuItemTitleColor = [UIColor blackColor];
        _menuIndicatorColor = [UIColor whiteColor];
