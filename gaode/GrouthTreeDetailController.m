...
@interface GrouthTreeDetailController () <EGOTableViewDelegate,UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong)EGOTableView *tableView;
@end

@implementation GrouthTreeDetailController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationController.navigationBarHidden = NO;
    [self setWhiteNavBg];
    [self initializeWhiteBackgroudView:@"成长树详情"];
    [self initView];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *identifier = @"GrothDetailIdentifier";
    GrouthTreeDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[GrouthTreeDetailCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
